...
public class UserBasePageUI {
	...
	public static final String ORDERS_LINK = "xpath=//div[@class='master-wrapper-content']//a[text()='Orders']";
	public static final String DOWNLOADABLE_PRODUCT_LINK = "xpath=//div[@class='master-wrapper-content']//a[text()='Downloadable products']";
	public static final String BACKINSTOCKSUB_LINK = "xpath=//div[@class='master-wrapper-content']//a[text()='Back in stock subscriptions']";
